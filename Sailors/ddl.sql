...
*/
-- --------------------------------------------------------------------
/*The following DROP command is inserted for convenience so that if you
need to recompile your code, it will drop the table (if it already
exists).
*/
DROP TABLE Students;
--
...
CONSTRAINT IC5 FOREIGN KEY (mentor) 
